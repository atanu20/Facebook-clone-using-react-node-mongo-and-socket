    ...
    return (
      ...
      <div className="topbarcontainer">
          <div className="tobarleft">
            <span className="logo" onClick={()=>history.push("/")}>SocialAPP</span>
          </div>
          ...
          <div className="topbarright">
              <div className="topbarlinks">
                  <span className="topbarlink" onClick={()=>history.push("/")}>Home</span>
                  {
                      FacebookUserId ? (<>
                      <span className="topbarlink" onClick={Logout}>LogOut</span>
                      </>):
                      <span className="topbarlink" onClick={()=>history.push("/login")}>Login</span>
                  }
                  
              </div>
              <div className="topbaricons">
                  <div className="topbariconitem" onClick={()=>history.push('/followers')}>
                      <Person/>
                      {/* <span className="topbariconbadge">{mynot}</span> */}
                  </div>
                  <div className="topbariconitem" onClick={()=>history.push('/messanger')}>
                      <Chat/>
                      {/* <span className="topbariconbadge">1</span> */}
                  </div>
                  <div className="topbariconitem" onClick={()=>history.push('/notification')} >
                      <Notifications/>
                      {/* <span className="topbariconbadge">1</span> */}
                  </div>
              </div>
              <img src={myimg ? `../profile/${myimg}` : `../assets/pro.png`} alt=""  className="topbarimg" onClick={()=>history.push(`/profile/${FacebookUserId}`)} />
          </div>
      </div>
